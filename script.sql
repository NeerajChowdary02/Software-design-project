...
-- sql code for customer name and login credentials
...
-- sql code for customer orders based on location
...
-- SQL code for cutomer information such as address, city etc.
